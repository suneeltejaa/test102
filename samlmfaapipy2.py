...
print ("Options May Vary from person to person")
print ('[1] verificationOption0 = mobile app authenticate')
print ("[2] verificationOption1 = phone call")
print ("[3] verificationOption2 = smss")
print ("Your Choice:")
cho = int(input())
if cho > 3 :
...
####default
###change to input
verificationOptions = [ "verificationOption0" , "verificationOption1", "verificationOption2", "verificationOption3" ]
